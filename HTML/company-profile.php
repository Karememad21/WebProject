...
if (isset($_SESSION["email"])) {
    ...
    $sqltem = "SELECT * FROM `company_user` where company_email='$email'";
    $result = mysqli_query($conn, $sql);
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="company-profile.php" class="navbar-brand"> Profile</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-nav-demo">

            <ul class="nav navbar-nav navbar-right">
                <li><?php echo "<a href='home.php'>Home</a>" ?></li>
                <li><?php echo "<a href='edit-company-profile.php'>Edit Profile</a>" ?></li>
...
<div class="container profilepanel" style="margin-top: 20px; margin-bottom: 20px;">
    <div class="row panel">
        ...
        <div class="col-md-8  col-xs-12">
            ...
            ?>
            <img src="../IMG/company-profile-img2.jpg" class="img-thumbnail visible-xs picture_mob"/>
            <div class="header">
    ...
    <div class="row">
        <div class="col-md-2 col-sm-4 sidebar1">
            ...
            <div class="left-navigation">
                ...
                <ul class="list">
                    <?php
                    $sql = "SELECT * FROM company_liker WHERE company_email = '$email'";
                    $result = mysqli_query($conn, $sql);
                    $num_likers = mysqli_num_rows($result);
                    echo "<h5><strong>People Likes The Company: " . $num_likers . "</strong></h5>";
                    ?>
                </ul>
                <ul class="list">
                                        ...
                                        <div class="panel-body">
                                            <header class="text-left">
                                                <div class="comment-post">
                                                    <form method="post" <?php echo "action='getcompanyPost.php?user_email=$email' ";
